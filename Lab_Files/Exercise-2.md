...
1. Click on the **Import (1)** option at the top center and select **Notebook (2)** and click on the **From this computer (3)** option to import the notebook file from your local drive.
...
## Task 3: Run the notebook
Now we have to run the notebook to create the stream of artificial click events for our lab. For the Notebook to send the events to the correct Event Hub, we have to insert the information we have saved in the Task Create Event Stream. To run the notebook and create our data stream, please proceed with the following steps.
...
22. Click on the **Publish** button that is located in the toolbar at the top of the screen.
